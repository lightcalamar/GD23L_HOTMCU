...
#ifndef _GD23L_H_INCLUDED
#define _GD23L_H_INCLUDED
...
#define POR_PIN          48   // Definir el pin PD de las pantallas http://hotmcu.com 
#define CS               53 //10 Riverdi-shield   8  gameduino2
